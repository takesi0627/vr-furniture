...
namespace CurvedVRKeyboard {
    public class KeyboardItem : KeyboardComponent {
        ...
        public void SetFonts(Font font, Color color) {
            letter.font = font;
            letter.color = color;
        }
        ...
        public void FillMaterial (float scale) {
            quadFront.transform.localScale.Set(
                quadFront.transform.localScale.x * 1.5f,
                quadFront.transform.localScale.y,
                quadFront.transform.localScale.z
            );
        }
