...
namespace CurvedVRKeyboard {
    ...
    public class KeyboardCreatorEditor: Editor {
        ...
        private const string LAYOUT_SETUP = "Layout setup";
        ...
        private static GUIContent TEXT_FONT = new GUIContent("Text Font", "Font set to all keys");
        private static GUIContent TEXT_COLOR = new GUIContent("Text Color", "Color set to all keys");

        private static GUIContent ROW_SPACING = new GUIContent("Row Spacing", "Key spacing between each rows");
        private static GUIContent COLUMN_SPACING = new GUIContent("Column Spacing", "Key spacing between each column");
        ...
        private void DrawMaterials () {
            ...
            keyboardCreator.TextFont = EditorGUILayout.ObjectField(TEXT_FONT, keyboardCreator.TextFont, typeof(Font), true) as Font;
            keyboardCreator.TextColor = EditorGUILayout.ColorField(TEXT_COLOR, keyboardCreator.TextColor);
        }

        void DrawLayout () {
            GUILayout.Space(SPACING_MATERIALS);
            GUILayout.Label(LAYOUT_SETUP, EditorStyles.boldLabel);
            keyboardCreator.ColumnSpacing = EditorGUILayout.FloatField(COLUMN_SPACING, keyboardCreator.ColumnSpacing);
            keyboardCreator.RowSpacing = EditorGUILayout.FloatField(ROW_SPACING, keyboardCreator.RowSpacing);
        }
        ...
        private void HandleScaleChange () {
            ...
            if(!keyboardCreator.transform.localScale.x.Equals(keyboardScale.x)) { // X scale changed
                neededXScale = keyboardCreator.transform.localScale.x;
            } else if(!keyboardCreator.transform.localScale.z.Equals(keyboardScale.z)) { // Z scale changed
